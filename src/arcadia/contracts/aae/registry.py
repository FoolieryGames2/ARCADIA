...
_CONTRACTS: tuple[AAEContractRecord, ...] = (
    ...
    _contract(
        ...
        response="Per-candidate considered/accepted/partial/rejected/conflict/unresolved judgment plus lane semantic_status.",
        enums={
    ...
    _contract(
        ...
        local_prefixes=("CTX_",),
        response="Locally keyed Context-point proposals carrying text, support_refs, and supported|inference|unresolved mode, plus unresolved items.",
    ...
    _contract(
        ...
        response="Final grounded Context synthesis preserving relevant facts, constraints, conflicts, unresolved items, source refs, and do-not-assume boundaries.",
        enums=None,
    ...
    _contract(
        ...
        response="Per-requirement disposition, basis refs, need summary, work needs/evidence targets, blocker data, post-work obligations, and confidence.",
        enums={
    ...
    _contract(
        ...
        local_prefixes=("CA_",),
        response="Per-R terminal_status plus fulfilled/unmet components, blockers, failures, conflicts, persistence_effect, user-facing refs, result guidance, reason codes, and provenance.",
        enums={
    ...
    _contract(
        ...
        local_prefixes=("CP_",),
        response="Turn-level completion plan preserving every per-R standing exactly once, with overall posture, ordered result focus, shared facts/blockers/failures, disclosure seed, and diagnostics.",
    ...
    _contract(
        ...
        local_prefixes=("RCM_",),
        response="One bounded natural-language requirement comment that preserves the frozen terminal standing and authorized disclosures.",
